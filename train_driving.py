...
from util import init_logger, driving_filenames
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--data_path", dest="dataset_path", required=True, type=str,
                        metavar="FILE", help='path to Driving dataset')
    parser.add_argument("-c", "--ckpt", dest="checkpoint_path", default="./ckpt/", type=str,
    ...
    driving_dataset = driving_filenames(args.dataset_path)

    tf.logging.set_verbosity(tf.logging.ERROR)
    dispnet = DispNet(mode="traintest", ckpt_path=args.checkpoint_path, dataset=driving_dataset,
                      batch_size=args.batch_size, is_corr=CORR, corr_type="tf")
